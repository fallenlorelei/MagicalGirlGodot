...
onready var hpLabel = $HPTooltip/NinePatchRect/Label
onready var background = $HPTooltip/NinePatchRect/Background
...
func _ready():
	...
	SignalBus.connect("update_player_hp_bar", self, "update_hp_text")
